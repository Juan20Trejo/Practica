...
void impresionPuntos(int rango_1, int rango_2,int m,int b){
    rango_2++;
    int i;
    double x[100],y[100];
...
void gnuplotT(int m,int b,int rango_1,int rango_2){
    gnuplot_ctrl * h1;
    h1 = gnuplot_init();
    gnuplot_cmd(h1,"set xrange [%d:%d]",rango_1,rango_2);
