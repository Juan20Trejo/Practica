...
int gnuplot_write_multi_csv(
  ...
  /**
 * @brief impresionPuntos Sirve para hacer el calculo de donde estan ubicacdos los puntos de x , y de la ecuacion ingresada.
 * @param rango_1 Rango de inicio el cual sera otorgado por el usuario. 
 * @param rango_2 Rango de fin el cual es otorgado por el usuario.
 * @param m Termino dependiente el cual multiplicara a x.
 * @param b Termino independiente el cual se sumara a la multiplicacion.
 * @param i Variable auxiliar que nos ayudara a multiplicar a x;
 * @param x Arreglo donde se guardaran las coordenadas de x.
 * @param y Arreglo donde se guardaran las coordenadas de y.
 * @return void. 
*/
...
/**
 * @brief gnuplotT Sirve para graficar la ecuacion planteada, otorga los ejes x, y, imprime la ecuacion planteada como una etiqueta.
 * @param  m  Sirve para dar el valor multiplicado por x.  
 * @param  b Sirve para dar el valor que se le suma a x.
 * @param rango_1 Rango de inicio.
 * @param rango_2 Rango de fin.
 * @return  void. 
*/
